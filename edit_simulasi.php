...
<html lang="en">
	...
	<body id="kt_body" style="background-image: url(./assets/media/patterns/header-bg.png)" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <div class="flex-column" data-kt-stepper-element="content">
                                                        ...
                                                        <div class="fv-row mb-10">
                                                            ...
                                                            <label class="form-label d-flex align-items-center">
                                                                <span class="required">Parameter 1</span>
                                                    ...
                                                    <div class="flex-column" data-kt-stepper-element="content">
                                                        ...
                                                        <div class="fv-row mb-10">
                                                            <!--begin::Label-->
                                                            <label class="form-label d-flex align-items-center">
                                                                <span class="required">Publish ?</span>
                                                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Example tooltip"></i>
                                                            </label>
                                                            <!--end::Label-->
															...
															<div class="form-check form-switch form-check-custom form-check-success form-check-solid">
																<input class="form-check-input " type="checkbox" value="1" checked id="isPublish"/>
																<label class="form-check-label" for="isPublish" id="lbPublish">
																	Publish Simulation
																</label>
															</div>
                                                            <!--end::Input-->
        ...
        <script>
			...
			$('#isPublish').on('change',function(e){
				console.log("berubah");
				if($(this).is(':checked')){
					//console.log("publish game");
					$('#lbPublish').html("Publish Simulation");
				}else{
					$('#lbPublish').html("Simulation Drafted");
					//console.log("drafted game");
				}
			})
        </script>
