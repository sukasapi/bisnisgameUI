...
<html lang="en">
	...
	<body id="kt_body" style="background-image: url(./assets/media/patterns/header-bg.png)" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
						...
						<div class="content flex-row-fluid" id="kt_content">
                            ...
                            <div class="card shadow-sm">
                                <div class="card-header">
                                    <h3 class="card-title">Buat Simulasi Baru</h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-lg-row" id="kt_stepper_example_vertical">
                                            ...
                                            <div class="stepper-item me-5" data-kt-stepper-element="nav">
                                                ...
                                                <div class="stepper-wrapper d-flex align-items-center">
                                                    ...
                                                    <div class="stepper-label">
                                                        ...
                                                        <div class="stepper-desc">
                                                            Informasi Lingkungan Bisnis Awal
                                                        </div>
                                                    </div>
                                                    <!--end::Label-->
                                                </div>
                                        ...
                                        <div class="flex-row-fluid">
                                            <!--begin::Form-->
                                            <form class="form mx-auto" style="width:90%" novalidate="novalidate">
                                                <!--begin::Group-->
                                                <div class="mb-5">
                                                    <!--begin::Step 1-->
                                                    <div class="flex-column current" data-kt-stepper-element="content">
                                                        ...
                                                        <div class="fv-row mb-10">
                                                            <!--begin::Label-->
                                                            <label class="form-label">Deskripsi Simulasi</label>
                                                            <!--end::Label-->

                                                            <!--begin::Input-->
                                                            <textarea class="form-control form-control-solid" rows="8" name="desk_simulasi" placeholder="Masukkan Deskripsi Simulasi Maksimum 200 huruf"></textarea>
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                    </div>
                                                    ...
                                                    <div class="flex-column" data-kt-stepper-element="content">
                                                        <div class="d-flex flex-column pb-10">
                                                            ...
                                                            <button class="btn btn-danger btn-sm hover-rotate-start" data-bs-toggle="modal" data-bs-target="#mdAddTeam"  id="addTeam">Add Team</button>
                                                            </div>
                                                        </div>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true" style="">
                                                                                ...
                                                                                <div class="menu-item px-3">
                                                                                    <button data-sort='1' class="btn btn-sm btn-circle btn-warning-light px-3"><i class="bi bi-pen text-warning"></i> Edit</button>
                                                                                </div>
                                                                                <!--end::Menu item-->
                                                                                <!--begin::Menu item-->
                                                                                <div class="menu-item px-3">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>    
                                                                            ...
                                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true" style="">
                                                                                <!--begin::Menu item-->
                                                                                <div class="menu-item px-3">
                                                                                    <button data-sort='2' class="btn btn-sm btn-circle btn-warning-light px-3"><i class="bi bi-pen text-warning"></i> Edit</button>
                                                                                </div>
                                                                                <!--end::Menu item-->
                                                                                <!--begin::Menu item-->
                                                                                <div class="menu-item px-3">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true" style="">
                                                                                <!--begin::Menu item-->
                                                                                <div class="menu-item px-3">
                                                                                    <button data-sort='3' class="btn btn-sm btn-circle btn-warning-light px-3"><i class="bi bi-pen text-warning"></i> Edit</button>
                                                                                </div>
                                                                                <!--end::Menu item-->
                                                                                <!--begin::Menu item-->
                                                                                <div class="menu-item px-3">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" class="btn btn-success" hidden id="btCreate">
                                                            Buat Simulasi
                                                        </button>
                                                    </div>
                                                    <!--end::Wrapper-->
		...
		<div class="modal fade" id="mdAddTeam" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
				...
				<div class="modal-content">
					...
					<div class="modal-body py-lg-10 px-lg-10">
                        ...
                        <div class="form-floating input-group mb-7">
                            <input type="text" class="form-control required" id="nTeam" name="nTeam" placeholder="nama team yang akan ikut dalam simulasi"/>
                            <label for="nTeam" class="form-label required">Nama Team</label>
                            <button class="btn btn-circle btn-sm btn-primary" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" title="info" data-bs-content="Jika nama tim sudah ada, maka akan diberikan nama baru secara otomatis"><i class="bi bi-question-circle"></i></button>
                        </div>
                        <!--end::Input group-->
                        <div class="row g-9 mt-4">
                            <div class="col-md-6 col-xs-12 fv-row">
                                <!--begin::Input group-->
                                <div class="form-floating input-group mb-7">
                                    <input type="text" class="form-control " id="lTeam" name="lTeam" placeholder=""/>
                                    <label for="lTeam" class="form-label required">Username Leader/Direktur</label>
                                    <button class="btn btn-circle btn-sm btn-primary" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" title="info" data-bs-content="nama user yang akan menjadi leader/direktur tim.<br> Jika belum ada, maka akan otomatis membuat user baru"><i class="bi bi-question-circle"></i></button>
                                </div>
                                <!--end::Input group-->
                            </div>
                            <div class="col-md-6 col-xs-12 fv-row">
                                <!--begin::Input group-->
                                <div class="form-floating input-group mb-7">
                                    <input type="text" class="form-control " id="lnTeam" name="lTeam" placeholder=""/>
		...
		<div class="modal fade" id="mdEditTeam" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
			<div class="modal-dialog modal-dialog-centered mw-900px">
				<!--begin::Modal content-->
				<div class="modal-content">
        ...
        <script>
            ...
            stepper.on("kt.stepper.next", function (stepper) {
                ...
                var idxnow=stepper.getCurrentStepIndex();
                if(idxnow>=lastidx){
                    $("#btCreate").removeAttr("hidden");
                }else{   
                    $("#btCreate").attr("hidden",true);
                }
            });
