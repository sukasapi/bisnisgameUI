...
<?php 
   ...
   $_SESSION['title']=" <i class='fa fa-file-new fs-4x' style='color:#FFD700'></i>   Daftar Vendor  ";
   $_SESSION['idx']="form";
?>
<html lang="en">
	<!--begin::Head-->
	...
	<body id="kt_body" style="background-image: url(./assets/media/patterns/header-bg.png)" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
						...
						<div class="content flex-row-fluid" id="kt_content">
                            ...
                            <div class="card shadow-sm">
                                <div class="card-header">
                                    <h3 class="card-title">Vendor Simulasi <i>[judul atau nomor simulasi]</i></h3>
                                    <div class="card-toolbar">
                                        <a href="./simulasi.php" type="button" class="btn btn-sm btn-icon btn-active-color-primary">
                                ...
                                <div class="card-body">
									<div class="pb-10">
										<button class="btn btn-primary" id="addVendor" data-bs-toggle="modal" data-bs-target="#mdCreate">Tambah Vendor</button>
									</div>
		...
		<!--end::Drawers-->
		<!--begin::Modal-->
		<div class="modal fade" tabindex="-1" id="mdCreate">
			<div class="modal-dialog modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header">
						<h1 class="modal-title">Tambah Vendor</h1>
						<!--begin::Close-->
					...
					<div class="modal-body " style="min-height: 300px">
						<div class="py-5">
							<div class="rounded border p-10">
								<div class="mb-10">
									<span class="d-inline-block position-relative ms-2">
										...
										<span class="d-inline-block mb-2">
											...
											<small>Berisi nama dan deskripsi perusahaan</small>
										</span>
										<!--end::Label-->
								...
								<div class="mb-10">
									<label for="nama" class="required form-label">Nama Vendor</label>
									<input type="text" class="form-control form-control-solid" placeholder="Nama vendor"/>
								</div>
								<div class="mb-10">
									<label for="exampleFormControlInput1" class="form-label">Deskripsi Vendor</label>
									<textarea class="form-control form-control-solid" placeholder="Deskripsi Vendor" rows='6'></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-success" id="bsimpan">Edit</button>
					</div>
				</div>
			</div>
		</div>
		<div class="modal fade" tabindex="-1" id="mdEdit">
			<div class="modal-dialog modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header">
