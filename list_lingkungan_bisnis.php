...
<?php 
   ...
   $_SESSION['title']=" <i class='fa fa-file-new fs-4x' style='color:#FFD700'></i>   Daftar Lingkungan Bisnis  <i> [nama simulasi]</i> ";
   $_SESSION['idx']="form";
?>
<html lang="en">
	<!--begin::Head-->
						...
						<div class="content flex-row-fluid" id="kt_content">
                            ...
                            <div class="card shadow-sm">
                                <div class="card-header">
                                    <h3 class="card-title">Konfigurasi Lingkungan Bisnis  <i> [judul atau nomor simulasi]</i></h3>
