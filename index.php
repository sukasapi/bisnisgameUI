...
<?php 
   session_start();
   $_SESSION['title']="Simulasi Bisnis PT.LPP Agro Nusantara";
   $_SESSION['idx']="home";
?>
<html lang="en">
	<!--begin::Head-->
								...
								<div class="card-body">
									...
									<div class="row my-10">
										<div class="col-md-12 col-xs-12">
											<h2>DAFTAR FRONT END</h2>
											<p> Untuk kembali ke halaman ini, klik pada icon C di pojok kiri atas</p>
										</div>
									</div>
									<!--end::Row-->
									<!--begin::Row-->
									<div class="row my-10">
										<div class="col-md-12 col-xs-12">
											<h4>Konfigurasi dan Daftar Oleh Admin</h4>
											<ul class="list-group">
												<li class="list-group-item"><a href="./simulasi.php">Daftar Simulasi</a></li>
												<li class="list-group-item"><a href="./simulasi_page.php">Single-Page Simulasi</a></li>
												<li class="list-group-item"><a href="./create_simulasi.php">Pembuatan Simulasi</a></li>
												<li class="list-group-item"><a href="./edit_simulasi.php">Pengubahan Simulasi</a></li>
												<li class="list-group-item"><a href="./list_vendor.php">Daftar Vendor</a></li>
												<li class="list-group-item"><a href="./list_lingkungan_bisnis.php">Daftar Lingkungan Bisnis</a></li>
											</ul>
										</div>
									</div>
									<!--end::Row-->
									...
									<div class="row my-10">
										<div class="col-md-12 col-xs-12">
											<h4>Front End General Manager</h4>
											<ul class="list-group">
												<li class="list-group-item"><a href="./info_perusahaan.php">Informasi Perusahaan</a></li>
												<li class="list-group-item"><a href="./formD.php">Informasi Keuangan</a></li>
											</ul>
										</div>
									</div>
									<!--end::Row-->
									...
									<div class="row my-10">
										<div class="col-md-12 col-xs-12">
											<h4>Front End Player</h4>
											<ul class="list-group">
												<li class="list-group-item"><a href="./formA.php">Input Pengadaan</a></li>
												<li class="list-group-item"><a href="./formB.php">Input Produksi</a></li>
												<li class="list-group-item"><a href="./formC.php">Input Penjualan</a></li>
												<li class="list-group-item"><a href="./formD.php">Informasi Keuangan</a></li>
											</ul>
										</div>
									</div>
